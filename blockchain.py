...
def print_menu():
    ...
    print("5. Simulate Race Attack")
    print("6. Simulate Finney Attack")
    print("7. Exit")
...
def simulate_race_attack(blockchain):
    sender = input("Enter the sender: ")
    recipient1 = input("Enter the first recipient: ")
    recipient2 = input("Enter the second recipient: ")
    amount = float(input("Enter the amount: "))
    blockchain.simulate_race_attack(sender, recipient1, recipient2, amount)

def simulate_finney_attack(blockchain):
    sender = input("Enter the sender: ")
    recipient = input("Enter the recipient: ")
    amount = float(input("Enter the amount: "))
    blockchain.simulate_finney_attack(sender, recipient, amount)
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            simulate_race_attack(blockchain)
        elif choice == '6':
            simulate_finney_attack(blockchain)
        elif choice == '7':
            break
        else:
